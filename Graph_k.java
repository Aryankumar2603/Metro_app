...
public class Graph_k {
	...
	public static void Create_Metro_Map(Graph_k g) {
		g.addVertex("Salt lake sector V");
		g.addVertex("Karunamoyee");
		g.addVertex("Central Park");
		g.addVertex("City Centre");
		g.addVertex("Bengal Chemical");
		g.addVertex("Salt lake Stadium");
		g.addVertex("Phoolbagan");
		g.addVertex("Sealdah");

		g.addEdge("Salt lake sector V", "Karunamoyee", 1);
		g.addEdge("Karunamoyee", "Central Park", 1);
		g.addEdge("Central Park", "City Centre", 2);
		g.addEdge("City Centre", "Bengal Chemical", 1);
		g.addEdge("Bengal Chemical", "Salt lake Stadium", 2);
		g.addEdge("Salt lake Stadium", "Phoolbagan", 1);
		g.addEdge("Phoolbagan", "Sealdah", 1);
	}
